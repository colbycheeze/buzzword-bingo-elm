...
Elm.Main.make = function (_elm) {
   ...
   _U.list([]),
   _U.list([A2($Html.a,
   _U.list([$Html$Attributes.href("http://colbycheeze.com"),$Html$Attributes.target("_blank")]),
   _U.list([$Html.text("ColbyCheeZe Blog")]))]));
   var pageHeader = A2($Html.h1,_U.list([]),_U.list([$Html.text("Buzzword Bingo!")]));
   ...
   var entryItem = F2(function (address,entry) {
      ...
      _U.list([A2($Html.button,_U.list([$Html$Attributes.$class("delete"),A2($Html$Events.onClick,address,Delete(entry.id))]),_U.list([]))
              ,A2($Html.span,_U.list([$Html$Attributes.$class("phrase")]),_U.list([$Html.text(entry.phrase)]))
   ...
   var Sort = {ctor: "Sort"};
   var NoOp = {ctor: "NoOp"};
   var isEnter = function (code) {    return _U.eq(code,13) ? Add : NoOp;};
   var entryForm = F2(function (address,model) {
      ...
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ...
                      ,A2($Html$Events.onKeyPress,address,isEnter)]),
              _U.list([]))
              ,A2($Html.input,
              ...
              _U.list([]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("add"),A2($Html$Events.onClick,address,Add),A2($Html$Events.onKeyPress,address,isEnter)]),
   ...
   var init = {entries: _U.list([A4(Entry,"Doing Agile",200,false,2)
                                ,A4(Entry,"In The Cloud",300,false,3)
                                ,A4(Entry,"Future-Proof",100,false,1)
                                ,A4(Entry,"Rock-Star Ninja",400,false,4)])
              ,phraseInput: ""
              ,pointsInput: ""
              ,nextID: 5};
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "Add": var isInvalid = function (model) {    return $String.isEmpty(model.phraseInput) || $String.isEmpty(model.pointsInput);};
           var entryToAdd = A4(Entry,model.phraseInput,$BingoUtils.parseInt(model.pointsInput),false,model.nextID);
